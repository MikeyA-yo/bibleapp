...
export default function Nav() {
  ...
  return (
    <>
      <div>
        <div className="lg:flex md:flex bg-[#01204e] bg-opacity-85 justify-between fixed top-0 w-full z-50  h-20 hidden p-8 ">
          <div>
        ...
        <div className="flex flex-col bg-[#01204e] bg-opacity-85 gap-2 md:hidden z-50 w-full    fixed top-0 lg:hidden p-4">
