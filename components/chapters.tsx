    ...
    <div className="h-screen  bg-center bg-cover bg-fixed chapters">
      <div className="h-full w-full bg-black bg-opacity-50 flex flex-col justify-center gap-3 items-center  lg:gap-3 md:gap-3">
        <div className="pt-32 lg:pt-16 md:pt-16">
          <div className="relative group rounded-lg w-64 z-50 bg-gray-50 overflow-hidden before:absolute before:w-12 before:h-12 before:content[''] before:right-0 before:bg-violet-500 before:rounded-full before:blur-lg before:[box-shadow:-60px_20px_10px_10px_#F9B0B9]">
            <svg
              y={0}
